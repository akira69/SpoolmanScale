...
struct lv_obj_t { int x=0, y=0, width=0, height=0, bg=0; std::string text; bool canvas=false; bool disabled=false; lv_event_cb_t cb=nullptr; void* user_data=nullptr; };
...
inline lv_obj_t* lv_label_create(lv_obj_t* p) { auto* o=lv_obj_create(p); o->text="Text"; return o; }
inline lv_obj_t* lv_canvas_create(lv_obj_t* p) { auto* o=lv_obj_create(p); o->canvas=true; return o; }
...
inline void lv_obj_set_height(lv_obj_t* o, int h) { o->height=h; }
...
inline void lv_label_set_text(lv_obj_t* o, const char* text) { o->text=text; }
inline void lv_label_set_text_fmt(lv_obj_t*, const char*, ...) {}
inline void* lv_event_get_user_data(lv_event_t* e) { return e->user_data; }
inline void lv_refr_now(void*) {}
inline void lv_canvas_set_buffer(lv_obj_t* o, void*, int w, int h, int) { o->width=w; o->height=h; }
...
static const int lv_font_montserrat_ext_14=0, lv_font_montserrat_ext_16=0, lv_font_montserrat_ext_20=0;
