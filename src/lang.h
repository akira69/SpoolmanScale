...
enum StringID {
  ...
  STR_LABEL_PC_FAILED,
  STR_LABEL_PRINTER_SCAN,
  STR_LABEL_PRINTER_PRINT,
  STR_LABEL_PRINTER_NONE,
  STR_LABEL_PRINTER_SELECT,
  STR_LABEL_PRINTER_MEDIA,
  STR_LABEL_PRINTER_FETCH,
  STR_LABEL_PRINTER_SEND,
  STR_LABEL_PRINTER_SENT,
  STR_LABEL_PRINTER_FAILED,
  STR_LABEL_PRINTER_NO_PSRAM,
  STR_LABEL_PRINTER_CONNECT_RETRY,
  STR_LABEL_PRINTER_RECOVERY_TITLE,
  STR_LABEL_PRINTER_RECOVERY_TEXT,

  STR_SPOOLS_TITLE,
  STR_SPOOLS_SEARCH,
  STR_SPOOLS_CLEAR,
  STR_SPOOLS_SEARCH_HINT,
  STR_SPOOLS_SEARCH_EMPTY,
  STR_SPOOLS_LOADING,
  ...
  STR_PRINTER_TITLE,
  STR_PRINTER_NONE,
  STR_PRINTER_SELECTED,
  STR_PRINTER_CLEAR,
  STR_PRINTER_SCANNING,
  STR_PRINTER_AVAILABLE,
  STR_PRINTER_SCAN_HINT,
  STR_PRINTER_SCAN,
  STR_PRINTER_SCAN_EMPTY,
  STR_PRINTER_SELECT_DEVICE,
  STR_PRINTER_MODEL,
  STR_PRINTER_EXPERIMENTAL,
  STR_PRINTER_UNKNOWN_DEVICE,
  STR_PRINTER_LOADED_SIZE,
  STR_PRINTER_SIZE_HELP,
  STR_PRINTER_CUSTOM_SIZE,
  STR_PRINTER_WIDTH_ACROSS,
  STR_PRINTER_FEED_LENGTH,
